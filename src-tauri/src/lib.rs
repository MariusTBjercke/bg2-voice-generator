...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::synthesis::list_line_synthesis_previews,
            ...
            commands::harvest::list_sound_resref_usage,
            ...
            commands::generate::list_generatable_lines_page,
            commands::generate::list_generatable_line_ids,
            commands::generate::list_generation_filter_options,
            commands::generate::list_completed_generations,
            commands::generate::list_generation_diagnostics,
            commands::generate::list_render_candidates_for_lines,
            ...
            commands::voice_profiles::list_voice_profile_usage,
