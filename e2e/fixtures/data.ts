...
export const speakerGroups: SpeakerGroup[] = [
  {
    ...
    variant_count: 1,
    line_count: 103,
    approved_sample_count: 4,
    approved_sound_count: 4,
    sample_count: 4,
    clone_status: "ready",
...
export const referenceSamples: ReferenceSample[] = [
  ...
  },
  {
    ...
    provenance_json: JSON.stringify({
      origin: "dialogue_state",
      cre_resref: "xzar",
      source_sound_resref: "sthma06",
      attribution_confidence: 1,
      source_text: "No one crosses the Shadow Thieves and lives!",
    ...
    decision: "approved",
    local_derivative_path: "C:\\fixture\\workspace\\xzar\\sthma06.wav",
  },
  {
    id: 5,
    speaker_id: 2,
    ...
    decision: "approved",
    local_derivative_path: "C:\\fixture\\workspace\\montaron\\sthma06.wav",
  },
];

/** Project-wide sound resref usage (mock for Harvest/Binding badges). */
export const soundResrefUsage: SoundResrefUsageEntry[] = [
  {
    source_sound_resref: "sthma06",
    character_count: 2,
    bound_character_count: 1,
    characters: [
      {
        identity_key: "22570:1",
        display_name: "Xzar",
...
/** Project-wide voice profile usage (mock for Binding library badges). */
export const voiceProfileUsage: VoiceProfileUsageEntry[] = [
  {
    voice_profile_id: 100,
    character_count: 2,
    pool_count: 1,
